...
class PS_Pagination {
        ...
        function renderFirst($tag = 'First') {
            ...
            //default to one (1)
            return " <a href='javascript:void(0);' OnClick='getdata(\"1\",\"$this->append\",\"\", \"\")' title='First Page'>$tag</a> ";
                }
        }
        ...
        function renderLast($tag = 'Last') {
            ...
            return " <a href='javascript:void(0);' OnClick='getdata(\"$pageno\",\"$this->append\", \"\", \"\")' title='Last Page'>$tag</a> ";
                }
        }
        ...
        function renderNext($tag = '&gt;&gt;') {
            ...
            $pageno = $this->page + 1;
            return " <a href='javascript:void(0);' OnClick='getdata(\"$pageno\",\"$this->append\", \"\", \"\")' title='Next Page'>$tag</a> ";
                } else {
                        return $tag;
                }
        }
        ...
        function renderPrev($tag = '&lt;&lt;') {
            ...
            $pageno = $this->page - 1;
            return " <a href='javascript:void(0);' OnClick='getdata(\"$pageno\",\"$this->append\",\"\", \"\")' title='Previous Page'>$tag</a> ";
                } else {
                        return " $tag ";
                }
        }
        ...
        function renderNav($prefix = '<span class="page_link">', $suffix = '</span>') {
                ...
                //$pageno = $this->page + 1;
                $links .= " <a href='javascript:void(0);' OnClick='getdata( $i,\"$this->append\",\"\", \"\" )' title='Another page'>$i</a> ";
                        }
                }
